...
import com.inimitable.util.Utils;
...
public class SummonerReport {
    ...
    private final SummonerAPI summonerAPI = new SummonerAPI();

    private final MatchAPI matchAPI = new MatchAPI();

    public SummonerReport(String name) throws ExecutionException, InterruptedException {
        this.summonerDTO = summonerAPI

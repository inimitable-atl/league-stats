...
public class UserReport extends ReportGenerator {
    ...
    final private List<SummonerReport> summonerReports = new ArrayList<>();
    ...
    private void addPerSummoner(DateTime startTime, DateTime endTime) {
        for (RiotSummoner summoner : riotUser.summoners) {
            ...
            var summonerReport = new SummonerReport(summoner);
            summonerReports.add(summonerReport);
    ...
    private void addPerChampion(SummonerReport summonerReport) {
        for (ChampionReport championReport : summonerReport.getChampionReportMap().values()) {
    ...
    public String toString() {
        ...
        sorted = new ArrayList<>(summonerReports);
        sortByWinPercentage(sorted);
